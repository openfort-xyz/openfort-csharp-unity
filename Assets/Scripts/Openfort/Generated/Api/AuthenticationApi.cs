...
namespace Openfort.Api
{
    ...
    public interface IAuthenticationApiSync : IApiAccessor
    {
        ...
        PlayerResponse VerifyOAuth(AuthenticateOAuthRequest authenticateOAuthRequest);
        ...
        ApiResponse<PlayerResponse> VerifyOAuthWithHttpInfo(AuthenticateOAuthRequest authenticateOAuthRequest);
        /// <summary>
    ...
    public interface IAuthenticationApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<PlayerResponse> VerifyOAuthAsync(AuthenticateOAuthRequest authenticateOAuthRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<PlayerResponse>> VerifyOAuthWithHttpInfoAsync(AuthenticateOAuthRequest authenticateOAuthRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Retrieve player by token.
        /// </summary>
        /// <remarks>
    ...
    public partial class AuthenticationApi : IDisposable, IAuthenticationApi
    {
        ...
        {
            Openfort.Client.ApiResponse<GetSigninUrlResponse> localVarResponse = InitOAuthWithHttpInfo(oAuthInitRequest);
            return localVarResponse.Data;
        }
        ...
        /// <param name="oAuthInitRequest"></param>
        /// <returns>ApiResponse of GetSigninUrlResponse</returns>
        public Openfort.Client.ApiResponse<GetSigninUrlResponse> InitOAuthWithHttpInfo(OAuthInitRequest oAuthInitRequest)
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (GetSigninUrlResponse)</returns>
        public async System.Threading.Tasks.Task<Openfort.Client.ApiResponse<GetSigninUrlResponse>> InitOAuthWithHttpInfoAsync(OAuthInitRequest oAuthInitRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'oAuthInitRequest' is set
            if (oAuthInitRequest == null)
                throw new Openfort.Client.ApiException(400, "Missing required parameter 'oAuthInitRequest' when calling AuthenticationApi->InitOAuth");
            ...
            var task = this.AsynchronousClient.PostAsync<GetSigninUrlResponse>("/iam/v1/oauth/init", localVarRequestOptions, this.Configuration, cancellationToken);
        ...
        {
            Openfort.Client.ApiResponse<AuthPlayerResponse> localVarResponse = UnlinkOAuthWithHttpInfo(linkRequest);
            return localVarResponse.Data;
        }
        ...
        /// <param name="linkRequest"></param>
        /// <returns>ApiResponse of AuthPlayerResponse</returns>
        public Openfort.Client.ApiResponse<AuthPlayerResponse> UnlinkOAuthWithHttpInfo(LinkRequest linkRequest)
        {
            // verify the required parameter 'linkRequest' is set
            if (linkRequest == null)
                throw new Openfort.Client.ApiException(400, "Missing required parameter 'linkRequest' when calling AuthenticationApi->UnlinkOAuth");
        ...
        {
            var task = UnlinkOAuthWithHttpInfoAsync(linkRequest, cancellationToken);
#if UNITY_EDITOR || !UNITY_WEBGL
            Openfort.Client.ApiResponse<AuthPlayerResponse> localVarResponse = await task.ConfigureAwait(false);
#else
            Openfort.Client.ApiResponse<AuthPlayerResponse> localVarResponse = await task;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (AuthPlayerResponse)</returns>
        public async System.Threading.Tasks.Task<Openfort.Client.ApiResponse<AuthPlayerResponse>> UnlinkOAuthWithHttpInfoAsync(LinkRequest linkRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'linkRequest' is set
            if (linkRequest == null)
                throw new Openfort.Client.ApiException(400, "Missing required parameter 'linkRequest' when calling AuthenticationApi->UnlinkOAuth");
        ...
        /// <param name="authenticateOAuthRequest"></param>
        /// <returns>PlayerResponse</returns>
        public PlayerResponse VerifyOAuth(AuthenticateOAuthRequest authenticateOAuthRequest)
        {
            Openfort.Client.ApiResponse<PlayerResponse> localVarResponse = VerifyOAuthWithHttpInfo(authenticateOAuthRequest);
            return localVarResponse.Data;
        }
        ...
        /// <param name="authenticateOAuthRequest"></param>
        /// <returns>ApiResponse of PlayerResponse</returns>
        public Openfort.Client.ApiResponse<PlayerResponse> VerifyOAuthWithHttpInfo(AuthenticateOAuthRequest authenticateOAuthRequest)
        {
            // verify the required parameter 'authenticateOAuthRequest' is set
            if (authenticateOAuthRequest == null)
                throw new Openfort.Client.ApiException(400, "Missing required parameter 'authenticateOAuthRequest' when calling AuthenticationApi->VerifyOAuth");
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of PlayerResponse</returns>
        public async System.Threading.Tasks.Task<PlayerResponse> VerifyOAuthAsync(AuthenticateOAuthRequest authenticateOAuthRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            var task = VerifyOAuthWithHttpInfoAsync(authenticateOAuthRequest, cancellationToken);
#if UNITY_EDITOR || !UNITY_WEBGL
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (PlayerResponse)</returns>
        public async System.Threading.Tasks.Task<Openfort.Client.ApiResponse<PlayerResponse>> VerifyOAuthWithHttpInfoAsync(AuthenticateOAuthRequest authenticateOAuthRequest, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'authenticateOAuthRequest' is set
            if (authenticateOAuthRequest == null)
                throw new Openfort.Client.ApiException(400, "Missing required parameter 'authenticateOAuthRequest' when calling AuthenticationApi->VerifyOAuth");
        ...
        public Openfort.Client.ApiResponse<PlayerResponse> VerifyOAuthTokenWithHttpInfo(OAuthProvider provider, OAuthRequest oAuthRequest)
        {
            // verify the required parameter 'oAuthRequest' is set
            if (oAuthRequest == null)
                throw new Openfort.Client.ApiException(400, "Missing required parameter 'oAuthRequest' when calling AuthenticationApi->VerifyOAuthToken");
