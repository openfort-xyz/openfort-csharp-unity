...
namespace Openfort.OpenfortSDK.Model
{
    ...
    public partial class CreateEcosystemConfigurationRequest : IEquatable<CreateEcosystemConfigurationRequest>
    {
        ...
        /// <param name="ecosystemWalletDomains">URLs where the ecosystem wallet is hosted..</param>
        ...
        public CreateEcosystemConfigurationRequest(string customDomain = default(string), string primaryColor = default(string), string primaryColorForeground = default(string), string radius = default(string), string logoUrl = default(string), List<string> ecosystemWalletDomains = default(List<string>), string termsOfServiceUrl = default(string), string privacyPolicyUrl = default(string), string faviconUrl = default(string), List<Dictionary<string, object>> dashboardExamples = default(List<Dictionary<string, object>>), List<Dictionary<string, object>> dashboardSDKs = default(List<Dictionary<string, object>>))
        {
        ...
        /// </summary>
        /// <value>URLs where the ecosystem wallet is hosted.</value>
        [DataMember(Name = "ecosystemWalletDomains", EmitDefaultValue = false)]
