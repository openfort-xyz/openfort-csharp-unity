...
namespace VoltstroStudios.UnityWebBrowser.Core
{
    ...
    public class WebBrowserClient : IWebBrowserClient, IDisposable
    {
        ...
        public static string ENGINE_FILE_LOCATION = "Packages/com.openfort.sdk/Runtime/ThirdParty/UnityWebBrowser.Engine.Cef.Win-x64/Engine/";
        private const string OPENFORTSDK_PACKAGE_RESOURCES_DIRECTORY = "Packages/com.openfort.sdk/Runtime/Resources";
        private const string INITIAL_URL = "https://www.openfortgaming.com/";
        ...
        public async UniTask Init(int engineStartupTimeout = 30000)
        {
            ...
            string filePath = "";
#if UNITY_EDITOR
            filePath = Constants.SCHEME_FILE + Path.GetFullPath($"{OPENFORTSDK_PACKAGE_RESOURCES_DIRECTORY}{Constants.OPENFORTSDK_HTML_FILE_NAME}");
#else
#if UNITY_STANDALONE_WIN || (UNITY_ANDROID && UNITY_EDITOR_WIN) || (UNITY_IPHONE && UNITY_EDITOR_WIN)
            filePath = Constants.SCHEME_FILE + Path.GetFullPath(Application.dataPath) + Constants.OPENFORTSDK_DATA_DIRECTORY_NAME + Constants.OPENFORTSDK_HTML_FILE_NAME;
#endif
#endif
            initialUrl = filePath;
