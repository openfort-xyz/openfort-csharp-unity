...
namespace Openfort.Model
{
    ...
    public partial class MembersResponse : IEquatable<MembersResponse>
    {
        /// <summary>
        ...
        public MembersResponse(string _object = default(string), string url = default(string), List<Object> data = default(List<Object>))
        {
            // to ensure "_object" is required (not null)
            if (_object == null)
            {
                throw new ArgumentNullException("_object is a required property for MembersResponse and cannot be null");
            }
            this.Object = _object;
