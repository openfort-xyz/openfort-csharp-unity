...
namespace Openfort.Model
{
    ...
    public partial class UpdatePolicyRuleRequest : IEquatable<UpdatePolicyRuleRequest>
    {
        ...
        public UpdatePolicyRuleRequest(PolicySchema type = default(PolicySchema), string functionName = default(string), string contract = default(string))
        {
            this.Type = type;
            // to ensure "functionName" is required (not null)
            if (functionName == null)
            {
                throw new ArgumentNullException("functionName is a required property for UpdatePolicyRuleRequest and cannot be null");
            }
            this.FunctionName = functionName;
            // to ensure "contract" is required (not null)
            if (contract == null)
            {
                throw new ArgumentNullException("contract is a required property for UpdatePolicyRuleRequest and cannot be null");
            }
