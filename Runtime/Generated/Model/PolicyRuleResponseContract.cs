...
{
    /// <summary>
    /// PolicyRuleResponseContract
    /// </summary>
    [JsonConverter(typeof(PolicyRuleResponseContractJsonConverter))]
    [DataContract(Name = "PolicyRuleResponse_contract")]
    public partial class PolicyRuleResponseContract : AbstractOpenAPISchema, IEquatable<PolicyRuleResponseContract>
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PolicyRuleResponseContract {\n");
        ...
        {
            return JsonConvert.SerializeObject(this.ActualInstance, PolicyRuleResponseContract.SerializerSettings);
        }

        /// <summary>
        /// Converts the JSON string into an instance of PolicyRuleResponseContract
        /// </summary>
        /// <param name="jsonString">JSON string</param>
        /// <returns>An instance of PolicyRuleResponseContract</returns>
        public static PolicyRuleResponseContract FromJson(string jsonString)
        {
            PolicyRuleResponseContract newPolicyRuleResponseContract = null;
            ...
            try
            {
                newPolicyRuleResponseContract = new PolicyRuleResponseContract(JsonConvert.DeserializeObject<ContractResponse>(jsonString, PolicyRuleResponseContract.SerializerSettings));
        ...
        {
            return this.Equals(input as PolicyRuleResponseContract);
        }

        /// <summary>
        /// Returns true if PolicyRuleResponseContract instances are equal
        /// </summary>
        /// <param name="input">Instance of PolicyRuleResponseContract to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PolicyRuleResponseContract input)
        {
            if (input == null)
                return false;
    ...
    /// <summary>
    /// Custom JSON converter for PolicyRuleResponseContract
    /// </summary>
    public class PolicyRuleResponseContractJsonConverter : JsonConverter
    {
        /// <summary>
        ...
        {
            writer.WriteRawValue((string)(typeof(PolicyRuleResponseContract).GetMethod("ToJson").Invoke(value, null)));
        }
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            {
                return PolicyRuleResponseContract.FromJson(JObject.Load(reader).ToString(Formatting.None));
            }
            return null;
        }
