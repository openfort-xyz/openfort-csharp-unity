...
namespace Openfort.Model
{
    ...
    public partial class Strategy : IEquatable<Strategy>
    {
        ...
        public Strategy(string sponsorSchema = default(string), string tokenContract = default(string), string tokenContractAmount = default(string))
        {
            // to ensure "sponsorSchema" is required (not null)
            if (sponsorSchema == null)
            {
                throw new ArgumentNullException("sponsorSchema is a required property for Strategy and cannot be null");
            }
            this.SponsorSchema = sponsorSchema;
            // to ensure "tokenContract" is required (not null)
            if (tokenContract == null)
            {
                throw new ArgumentNullException("tokenContract is a required property for Strategy and cannot be null");
            }
            this.TokenContract = tokenContract;
            // to ensure "tokenContractAmount" is required (not null)
            if (tokenContractAmount == null)
            {
                throw new ArgumentNullException("tokenContractAmount is a required property for Strategy and cannot be null");
            }
        ...
        /// </summary>
        [DataMember(Name = "sponsor_schema", IsRequired = true, EmitDefaultValue = true)]
        public string SponsorSchema { get; set; }

        /// <summary>
        /// Gets or Sets TokenContract
        /// </summary>
        [DataMember(Name = "token_contract", IsRequired = true, EmitDefaultValue = true)]
        public string TokenContract { get; set; }

        /// <summary>
        /// Gets or Sets TokenContractAmount
        /// </summary>
        [DataMember(Name = "token_contract_amount", IsRequired = true, EmitDefaultValue = true)]
