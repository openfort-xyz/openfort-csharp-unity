...
namespace Openfort.Model
{
    ...
    /// InteractionResponse
    /// </summary>
    [DataContract(Name = "InteractionResponse")]
    public partial class InteractionResponse : IEquatable<InteractionResponse>
    {
        ...
        public InteractionResponse(string contract = default(string), string value = default(string), string functionName = default(string), List<Object> functionArgs = default(List<Object>))
        {
            // to ensure "contract" is required (not null)
            if (contract == null)
            {
                throw new ArgumentNullException("contract is a required property for InteractionResponse and cannot be null");
            }
            this.Contract = contract;
            // to ensure "functionName" is required (not null)
            if (functionName == null)
            {
                throw new ArgumentNullException("functionName is a required property for InteractionResponse and cannot be null");
            }
            this.FunctionName = functionName;
            // to ensure "functionArgs" is required (not null)
            if (functionArgs == null)
            {
                throw new ArgumentNullException("functionArgs is a required property for InteractionResponse and cannot be null");
            }
        ...
        {
            return this.Equals(input as InteractionResponse);
        }

        /// <summary>
        /// Returns true if InteractionResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of InteractionResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InteractionResponse input)
        {
            if (input == null)
            {
                return false;
