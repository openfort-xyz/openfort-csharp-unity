...
namespace Openfort.Model
{
    ...
    public partial class ApiAuthorizedNetworkListResponse : IEquatable<ApiAuthorizedNetworkListResponse>
    {
        ...
        public ApiAuthorizedNetworkListResponse(ResponseTypeLIST _object = default(ResponseTypeLIST), string url = default(string), List<ApiAuthorizedNetworkResponse> data = default(List<ApiAuthorizedNetworkResponse>), int start = default(int), int end = default(int), int total = default(int))
        {
            this.Object = _object;
